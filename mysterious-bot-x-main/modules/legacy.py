...
# ── Original implementation preserved below (do not delete) ──────────────────
# The code below is the original 10892-line implementation.
# It is kept for reference and rollback purposes.
# To restore: remove the "from modules.commands import *" line above
