...
Guidance for Claude Code working in this repo: a Python Discord moderation bot
(~16k LOC, discord.py 2.x, SQLite). Solo developer, owner `9mits`.
...
Branch prefixes: `fix/` `feat/` `chore/` `refactor/`.
...
.claude/memory/        project memory loaded into future sessions
```
