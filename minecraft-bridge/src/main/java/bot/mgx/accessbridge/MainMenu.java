 ...
 */
enum MainMenu {
    CRATES("Crates", "crate", "Open crates and see every reward's odds.", Material.CHEST, "block/chest"),
    ...
    SELL("Sell", "sell", "Turn items into money.", Material.HOPPER, "block/hopper"),
    ENDER_CHEST("Ender Chest", "echest", "Your storage, anywhere.", Material.ENDER_CHEST, "block/ender_chest"),
    ...
    CLANS("Clans", "clans", "Your clan, its treasury and its warps.", Material.SHIELD, "item/shield"),
     ...
     *
     * <p>Written out rather than derived from the material: the folder split is not a
     * rule ({@code lodestone_top}, {@code compass_00}), and asking a Material whether
     * it is a block needs the server registry, which a unit test does not have.
     */
    String sprite() {
        return sprite;
    }
