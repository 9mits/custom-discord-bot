...
enum MainMenu {
    ...
    SELL("Sell", "sell", "Turn items into money.", Material.GOLD_NUGGET, "item/gold_nugget"),
    ENDER_CHEST("Ender Chest", "echest", "Your storage, anywhere.", Material.ENDER_CHEST, "item/ender_eye"),
    HOMES("Homes", "homes", "Travel to a home you have set.", Material.WHITE_BED, "block/white_wool"),
    ...
    CLANS("Clans", "clans", "Your clan, its treasury and its warps.", Material.IRON_CHESTPLATE, "item/iron_chestplate"),
