...
ACTION_SPECS: tuple[ActionSpec, ...] = (
    ...
    _spec("kick-all-members", "Security", "Kick every removable member and bot, then remove the cleanup bot.", capability="server.reset", caller=("Discord Administrator",), bot=("administrator",), risk=RiskLevel.DESTRUCTIVE, related=("reset-server", "destroy-server")),
