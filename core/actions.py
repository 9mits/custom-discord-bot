...
ACTION_SPECS: tuple[ActionSpec, ...] = (
    ...
    _spec("tag", "Information", "Post a saved server tag.", examples=("/tag name:appeal-process",), related=("tags", "tag-admin create")),
    _spec("tags", "Information", "List every saved server tag.", examples=("/tags",), related=("tag",)),
    _spec("tag-admin create", "Configuration", "Create a new server tag.", capability="config_panel", caller=_ADMIN, ack=AcknowledgementPolicy.DEFER, risk=RiskLevel.CONFIGURATION, examples=("/tag-admin create name:rules content:Read #rules",), related=("tag", "tags")),
    _spec("tag-admin edit", "Configuration", "Change an existing tag's content.", capability="config_panel", caller=_ADMIN, ack=AcknowledgementPolicy.DEFER, risk=RiskLevel.CONFIGURATION, related=("tag-admin create",)),
    _spec("tag-admin delete", "Configuration", "Delete a server tag.", capability="config_panel", caller=_ADMIN, ack=AcknowledgementPolicy.DEFER, risk=RiskLevel.DESTRUCTIVE, related=("tag-admin create",)),
    _spec("selfroles", "Custom Roles", "Pick your own roles.", bot=("manage_roles",), examples=("/selfroles",), related=("selfrole-admin add",)),
    _spec("selfrole-admin add", "Custom Roles", "Allow members to assign themselves a role.", capability="config_panel", caller=_ADMIN, bot=("manage_roles",), ack=AcknowledgementPolicy.DEFER, risk=RiskLevel.CONFIGURATION, related=("selfroles", "selfrole-admin panel")),
    _spec("selfrole-admin remove", "Custom Roles", "Stop members assigning themselves a role.", capability="config_panel", caller=_ADMIN, ack=AcknowledgementPolicy.DEFER, risk=RiskLevel.CONFIGURATION, related=("selfrole-admin add",)),
    _spec("selfrole-admin panel", "Custom Roles", "Post the public self-role picker in this channel.", capability="config_panel", caller=_ADMIN, bot=("send_messages", "manage_roles"), ack=AcknowledgementPolicy.DEFER, risk=RiskLevel.CONFIGURATION, related=("selfrole-admin add",)),
