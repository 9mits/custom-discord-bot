...
ACTION_SPECS: tuple[ActionSpec, ...] = (
    ...
    _spec("reset-server", "Security", "Permanently clear server content while preserving members and bans.", capability="server.reset", caller=("Discord Administrator",), bot=("administrator",), risk=RiskLevel.DESTRUCTIVE, related=("security",)),
