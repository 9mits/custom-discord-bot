...
ACTION_SPECS: tuple[ActionSpec, ...] = (
    ...
    _spec("auditlog", "Cases", "Review who ran which commands.", capability="cases.read", caller=_STAFF, ack=AcknowledgementPolicy.DEFER, examples=("/auditlog user:@member", "/auditlog command:purge"), related=("cases", "history")),
