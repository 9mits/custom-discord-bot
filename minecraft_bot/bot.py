...
class MinecraftAccessBot(commands.Bot):
    ...
    async def handle_server_event(
        ...
        *,
        ...
        if not claimed or not event:
            return
        # Old production plugins may emit these until their next approved update.
        # They belonged to the retired opt-in notification system and are not actions.
        if category == "live_ping":
            return
    ...
    def _build_command_groups(self) -> tuple[app_commands.Group, ...]:
        ...
        @admin_group.command(
            ...
            description="Configure and post the verification panel for testing.",
        )
