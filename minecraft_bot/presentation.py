...
def rules_embed(*, agreement: bool = False) -> discord.Embed:
    ...
    description = (
        ...
        "full.\n\n"
        "**2. Theft has limits**\n"
        "Taking items during a declared conflict is part of the game. Emptying a "
        "player's storage, or stealing from someone with no part in the "
        "conflict, counts as griefing.\n\n"
        ...
        "**4. Keep PvP fair**\n"
        "Fighting, ambushes and declared wars are allowed. Spawn-killing, combat "
        "logging, corpse camping and pursuing a player who has clearly "
        "disengaged are not.\n\n"
        ...
        "Alliances, rivalries and betrayal belong to the story. Real arguments, "
        "grudges carried outside the game, and personal attacks do not.\n\n"
        "**8. Do not cheat**\n"
        ...
        "Alternate accounts used to evade a punishment, bypass a whitelist "
        "decision, or claim a second set of perks are prohibited.\n\n"
