...
def rules_embed(*, agreement: bool = False) -> discord.Embed:
    ...
    # One continuous blockquote. Alternating headings and quotes opens a separate
    # quote block per rule, and Discord pads each one until the list sprawls.
    description = (
        introduction
        + "> **1. Do not grief**\n"
        "> Destroying, stealing from or damaging another player's base, storage "
        "or farms is prohibited. Damage caused during an agreed fight must be "
        "repaired in full.\n"
        "> \n"
        "> **2. Do not cheat**\n"
        "> Hacked clients, X-ray, duping and exploits are banned on sight. A "
        "client mod is permitted only if it cannot reveal what you could not see "
        "yourself, or act on your behalf.\n"
        "> \n"
        "> **3. Keep PvP fair**\n"
        "> Fighting, ambushes and declared wars are allowed. Spawn-killing, "
        "combat logging, corpse camping and pursuing a player who has clearly "
        "disengaged are not.\n"
        "> \n"
        "> **4. Keep conflict proportional**\n"
        "> A prank or a stolen item never justifies destroying a base. "
        "Retaliation must leave the other player a fair chance to respond.\n"
        "> \n"
        "> **5. Keep it in character**\n"
        "> Alliances, rivalries, theft and betrayal belong to the story. "
        "Harassment, slurs and real-world arguments do not, and are acted on "
        "immediately.\n"
        "> \n"
        ...
        "> A loophole is not permission. Staff may intervene in any conflict "
        "that stops being fair, and their ruling stands.\n"
        "\n"
